...
const NowPlaying = () => {
    ...
    const { data } = useFetch(`${paginationUrl.pagiNowPlaying}page=${page}`);
  
    return (
        <>
            <header className="text-white text-4xl font-bold mb-4 group mx-10 md:mx-24">Now Playing page: {page}</header>
            <main>
                {data && (
