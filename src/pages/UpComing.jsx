...
const UpComing = () => {
    ...
    const { data } = useFetch(`${paginationUrl.pagiUpcoming}page=${page}`);
  
    return (
        <>
            <header className="text-white text-4xl font-bold mb-4 group mx-10 md:mx-24">Up Coming page: {page}</header>
            <main>
                {data && (
