...
const Populer = () => {
    ...
    const { data } = useFetch(`${paginationUrl.pagiPopular}page=${page}`);
  
    return (
        <>
            <header className="text-white text-4xl font-bold mb-4 group mx-10 md:mx-24">Populer page: {page}</header>
            <main>
                {data && (
